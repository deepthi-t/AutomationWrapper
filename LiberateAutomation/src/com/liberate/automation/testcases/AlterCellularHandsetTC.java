...
import com.liberate.automation.pom.AlterCellularHandset;
...
public class AlterCellularHandsetTC {

	static TestActions action = CommonLogin.action;
	static String testCase;
	static String testStatus;
	
	static String alterhandsetservicenumber;
	...
	public static void altercellularhandset() {
		...
		AlterCellularHandset ACH = new AlterCellularHandset(action);
